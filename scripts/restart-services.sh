...
echo "   scp -i ~/.ssh/coolanu-postgres docker-compose-https.yml ubuntu@3.72.76.56:/opt/tabsur/"
echo "   scp -i ~/.ssh/coolanu-postgres nginx-https.conf ubuntu@3.72.76.56:/opt/tabsur/"
echo ""
...
echo "   scp -i ~/.ssh/coolanu-postgres nginx-https-full.conf ubuntu@3.72.76.56:/opt/tabsur/nginx-https.conf"
echo ""
