      ...
      <div className="footer">
        ...
        TabIndicatorProps={{
          style: {
            ...
            <Tab label="My Meals"  icon={<img className="footer-icons" src={plus} alt={"meals map"} />}></Tab>
            <Tab label="Add Meal" icon={<img className="footer-icons" src={myMeals} alt={"meals map"} />}></Tab>
          </Tabs>
